...
$cb                             = new Template('SiapBantu', '1.0', 'assets');
...
$cb->author                     = 'Rozak Ilham Aditya';
$cb->robots                     = 'noindex, nofollow';
$cb->title                      = 'SiapBantu - Sistem Informasi Penyebaran Bantuan Langsung Tunai';
$cb->description                = 'SiapBantu - Bersama melawan covid-19';
