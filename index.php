...
<!-- Page Content -->
    <div class="content">
        <div class="col-md-12">
            <div class="block block-themed">
                <div class="block-header bg-gd-emerald">
                    <h3 class="block-title">Data Kependudukan  </h3>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-sm-table-cell" style="width: 20%;">Jumlah Keluarga</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="kependudukan?detail= " class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#modal-update=<?php echo base64_encode($data_KepalaKeluarga['idkk']) ?>" title="Lihat Detail">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="kependudukan?detail= " class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-update=<?php echo base64_encode($data_KepalaKeluarga['idkk']) ?>" title="Hapus Data">
                                                <i class="fa fa-trash"></i>
                                            </a>
                                        </td>
                                    </tr>
                                    <!-- Update Kartu Keluarga Modal -->
                                    ...
                                    <!-- END Update Kartu Keluarga Modal -->
                                    <?php $no++; } ?>
                                </tbody>
                            </table>
                        </div>
        ...
        <div class="col-md-12">
            <div class="block block-themed">
                <div class="block-header bg-gd-lake">
                    <h3 class="block-title">Hasil Perangkingan</h3>
                    <div class="block-options">
                        <button type="button" class="btn-block-option" data-toggle="block-option" data-action="fullscreen_toggle"></button>
                    </div>
                </div>
                <div class="block-content">
                    <h2 class="mt-20 h4 text-center text-muted font-w300 mb-0">HASIL RANGKING <i>SAW</i></h2>
                    <!-- Dynamic Table Full -->
                        <div class="block-content block-content-full">
                            <!-- DataTables functionality is initialized with .js-dataTable-full class in js/pages/be_tables_datatables.min.js which was auto compiled from _es6/pages/be_tables_datatables.js -->
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                ...
                                <tbody>
                                    <?php 
                                    require_once 'sawmethod.php';
                                    $rank = 1;
                                    foreach (array_reverse($nilai_v) as $v) {
                                        $idkartu = $v['alternatif'];
                                        $read_KepalaKeluarga_detail = readKartuKeluarga_detail($idkartu);
                                        $no = 1;
                                        while ($data_KepalaKeluarga_detail = mysqli_fetch_assoc($read_KepalaKeluarga_detail) ){
                                    ?>
                                    <tr>
                                        <td class="text-center"><?php echo $rank ?></td>
                                        <td class="font-w600"><?php echo $v['alternatif'] ?></td>
                                        <td class="font-w600"><?php echo $data_KepalaKeluarga_detail['nama']?></td>
                                        <td class="d-none d-sm-table-cell">
                                        </td>
                                        <td class="text-center">
                                           <?php echo $v['nilai'] ?>
